...
class AlbumDetailPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final albumSongs = ref.watch(libraryProvider).sortedSongs
    ...
    final isAlbumPlaying = currentSong != null &&
        albumSongs.any((s) => s.id == currentSong.id);
            ...
            actions: [
              Padding(
                ...
                child: GestureDetector(
                  onTap: () => _showAlbumMenu(
                    context, ref, albumSongs, durationLabel,
                  ),
                  child: Container(
                    width: 36,
                    height: 36,
                          ...
                          onTap: () {
                            if (albumSongs.isNotEmpty) {
                              ref
                                  ...
                                  .playSong(albumSongs.first, queue: albumSongs);
                            }
                          },
                        ),
                      ),
