...
class _ArtistsPageState extends ConsumerState<ArtistsPage> {
  ...
  void initState() {
    super.initState();
    final savedShape = SettingsStorageService.loadArtistShape();
    if (savedShape != null &&
        savedShape >= 0 &&
        savedShape < ArtistCardShape.values.length) {
      _shape = ArtistCardShape.values[savedShape];
    }
    _columns = SettingsStorageService.loadArtistColumns();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BackgroundWrapper(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            AppLocalizations.of(context).artistsTitle,
          ...
          actions: [
            IconButton(
              ...
              onPressed: () async {
                ...
                SettingsStorageService.saveArtistColumns(picked);
              },
            ),
            IconButton(
